...
def create_dataloaders(data_dir,batch_size = 64 , mean = (0.485, 0.456, 0.406),std = (0.229, 0.224, 0.225)):
    ...
    for i in range(epochs):
        ...
        if i % 10 == 0 :
            ...
            print('Epoch: {} \nTraining Loss: {:.6f} \tValidation Loss: {:.6f}\tValidation Accuracy: {}%'.format(
                i+1, train_loss, valid_loss, total_correct*100/len(valid_loader.dataset) ))
